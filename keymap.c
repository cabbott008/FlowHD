...
const uint16_t PROGMEM keymaps[] [MATRIX_ROWS] [MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_DLR,             KC_9,               KC_5,               KC_1,               KC_3,               KC_7,              TG(2),               TG(2),               KC_6,               KC_2,               KC_0,               KC_4,               KC_8,               KC_NO,
    ...
    KC_HOME,            KC_END,             KC_LEFT,            KC_RIGHT,           LT(3,KC_BSPC),                         MEH_T(KC_ESC),       HYPR_T(TG(1)),                           LT(3,KC_DEL),       KC_DOWN,            KC_UP,              KC_NO,              KC_MPLY,
                                                                                    LT(2,KC_T),         KC_ENTER,          KC_NO,               KC_NO,               KC_TAB,             LT(2,KC_SPC)
  ),

  [1] = LAYOUT_moonlander(
    KC_NO,              KC_PERC,            KC_TILD,            KC_PIPE,            KC_CIRC,            KC_LABK,           TG(2),               KC_TRNS,             KC_RABK,            KC_EQUAL,           KC_ASTR,            KC_PLUS,            KC_AMPR,            KC_NO,
