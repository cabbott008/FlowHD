...
const uint16_t PROGMEM keymaps[] [MATRIX_ROWS] [MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_HASH,            KC_9,               KC_5,               KC_1,               KC_3,               KC_7,              TG(2),               TG(2),               KC_6,               KC_2,               KC_0,               KC_4,               KC_8,               KC_AT,
    KC_BSPC,            KC_X,               KC_G,               KC_L,               KC_C,               KC_B,              LGUI(KC_GRV),        TG(2),               LT(0,KC_MINUS),     KC_U,               KC_O,               KC_Y,               KC_K,               KC_Q,
    OSL(1),             KC_R,               KC_S,               KC_N,               KC_D,               KC_W,              LT(0,KC_LBRC),       LT(0,KC_RBRC),       LALT(KC_BSPC),      KC_A,               KC_E,               KC_I,               KC_H,               OSL(1),
    LCTL_T(KC_Z),       LGUI_T(KC_J),       KC_F,               KC_M,               KC_P,               KC_V,                                                        QSPC,               CMASPC,             KC_QUOTE,           KC_DOT,             LSFT_T(KC_DQUO),    LALT_T(KC_SLSH),
    LALT_T(KC_HOME),    LSFT_T(KC_END),     KC_LEFT,            KC_RIGHT,           LT(3,KC_BSPC),                         MEH_T(KC_ESC),       HYPR_T(TG(1)),                           LT(3,KC_DEL),       KC_DOWN,            KC_UP,              LGUI_T(KC_NO),      LCTL_T(KC_MPLY),
                                                                                    LT(2,KC_T),         KC_ENTER,          KC_ENTER,            KC_TAB,              KC_TAB,             LT(2,KC_SPC)
  ),
  ...
  [1] = LAYOUT_moonlander(
    ...
    LSFT(KC_Z),         LSFT(KC_J),         LSFT(KC_F),         LSFT(KC_M),         LSFT(KC_P),         LSFT(KC_V),                                                  XCLMSPC,            SCLNSPC,            KC_LPRN,            LSFT(KC_SCLN),      KC_RPRN,            LALT_T(KC_BSLS),
    KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_BSPC,                               KC_TRNS,             KC_TRNS,                                 ELPS,               KC_PGDOWN,          KC_PGUP,            KC_TRNS,            KC_TRNS,
                                                                                    LSFT(KC_T),         LSFT(KC_ENTER),    LSFT(KC_ENTER),      LSFT(KC_TAB),        LSFT(KC_TAB),       KC_NO
  ),

  [2] = LAYOUT_moonlander(
    KC_TRNS,            KC_F9,              KC_F5,              KC_F1,              KC_F3,              KC_F7,             TO(0),               TG(2),               KC_F6,              KC_F2,              KC_F10,             KC_F4,              KC_F8,              KC_F11,
    ...
    TO(0),              KC_BSLS,            KC_LGUI,            KC_NO,              KC_BSPC,                               TO(0),               KC_TAB,                                  KC_KP_0,            KC_DOWN,            KC_UP,              KC_LEFT,            KC_RIGHT,
                                                                                    OSL(3),             KC_ENTER,          KC_ENTER,            KC_EQUAL,            KC_TAB,             KC_SPC
  ),

  [3] = LAYOUT_moonlander(
    KC_HASH,            KC_9,               KC_5,               KC_1,               KC_3,               KC_7,              TO(0),               TG(2),               KC_6,               KC_2,               KC_0,               KC_4,               KC_8,               KC_AT,
    KC_BSPC,            KC_X,               KC_G,               KC_L,               KC_C,               KC_B,              LGUI(KC_GRV),        TG(2),               KC_MINUS,           KC_U,               KC_O,               KC_Y,               KC_K,               KC_Q,
    OSL(1),             KC_R,               KC_S,               KC_N,               KC_D,               KC_W,              LT(0,KC_LBRC),       LT(0,KC_RBRC),       LALT(KC_BSPC),      KC_A,               KC_E,               KC_I,               KC_H,               OSL(1),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][4] = {
    ...
    [3] = { {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255}, {243,255,255} },
